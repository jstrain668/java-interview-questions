...
public class MinWindowSubString {
    ...
    public String smallestWindow(String s, String p)
    {
        ...
        Map<Character, Integer> dictP = new HashMap<Character, Integer>();
        for (Character ch : p.toCharArray()) {
            dictP.put(ch,dictP.getOrDefault(ch,0)+1);
        }
    ...
    public static void main(String[] args) {
        ...
        String p = "toc";
        System.out.println("Min window sub string: "+mw.smallestWindow(s,p));
    }
