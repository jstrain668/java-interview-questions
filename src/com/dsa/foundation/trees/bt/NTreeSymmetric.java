...
//Given two n-ary trees, the task is to check if they are the mirror of each other or not.

//Reference: https://www.geeksforgeeks.org/check-mirror-n-ary-tree/

//The main approach is to use one list of stack and one list of queue to store to value of nodes given in the form of
// two arrays.
...
public class NTreeSymmetric {
    ...
    //
    //3. Now iterate over the array and pop item from both stack and queue and check if they are same, if not same then
    // return 0.
